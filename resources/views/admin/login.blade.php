                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign Admin to continue to WIT.</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form action="{{ route('admin.login.post') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter username" required>
                                        @if($errors->has('email'))
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy;
                            <script>document.write(new Date().getFullYear())</script> Social Learn. Crafted with <i class="mdi mdi-heart text-danger"></i> by Social Learn
                        </p>
                    </div>
                </div>
            </div>
