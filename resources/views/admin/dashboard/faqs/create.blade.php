...
@section('title') Create FAQs  @endsection
@section('css')
                        ...
                        <div class="card mt-4 d-flex flex-row">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Create FAQs</h5>
                                </div>
                                <div class="p-2">
                                    ...
                                    <form action="{{ route('admin.faq.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="status" class="form-label">Content</label>
                                            <div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <select class="form-control @error('status') is-invalid @enderror" name="status" id="" required>
                                                    <option value="enabled" {{ ($faq->status === 'active') ? 'selected' : '' }}>Enabled</option>
                                                    <option value="disabled" {{ ($faq->status === 'inacti') ? 'selected' : '' }}>Disabled</option>
                                                </select>
                                            </div>
