            ...
            <div class="container-fluid">
                ...
                <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                    <div class="row g-4">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{ $user->profile_photo }}" alt="user-img" class="img-thumbnail rounded-circle" />
                            </div>
                        </div>
                        <!--end col-->
                        <div class="col">
                            <div class="p-2">
                                ...
                                <p class="text-white-75">{{ ($user->profile) ? $user->profile->company : '' }}</p>
                                <div class="hstack text-white-50 gap-1">
                                    <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ ($user->profile) ? $user->profile->location : '' }}</div>
                                    <div>
                                        <i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ ($user->profile) ? $user->profile->company : '' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="d-flex profile-wrapper">
                                ...
                                <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab">
                                            <i class="ri-list-unordered d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Notifications</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <a href="#" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Connect </a>
                                    @endif
                                </div>
                            </div>
                            <!-- Tab panes -->
                            <div class="tab-content pt-4 text-muted">
                                        ...
                                        <div class="col-xxl-3">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-borderless mb-0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-muted">{{ ($user->profile) ? $user->profile->location : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2 fs-15">
                                                        @foreach($user->interests as $interest)
                                                            <a href="javascript:void(0);" class="badge badge-soft-primary">{{ $interest->name }}</a>
                                                        @endforeach
                                                    </div>
                                                </div><!-- end card body -->
                                            </div><!-- end card -->
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="{{ $suggestion->profile_photo }}" alt="" class="img-fluid rounded-circle" />
                                                                </div>
                                                            <div class="flex-grow-1">
                                                                <div>
                                                                    <h5 class="fs-14 mb-1">{{ $suggestion->first_name }} {{ $suggestion->last_name }}</h5>
                                                                    <p class="fs-13 text-muted mb-0">{{ ($suggestion->profile) ? $suggestion->profile->job_title : '' }} </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center mb-4">
                                                        <div class="flex-grow-1">
                                                            <h5 class="card-title mb-0">Suggested Posts</h5>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex mb-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                <a href="javascript:void(0);">
                                                                    <h6 class="text-truncate fs-14">{{ $randomPost->title }}</h6>
                                                                </a>
                                                                <p class="text-muted mb-0">{{ $randomPost->created_at }}</p>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <div class="d-flex mt-4">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <h6 class="text-truncate mb-0">{{ ($user->profile) ? $user->profile->job_title : '' }}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-6 col-md-4">
                                                            <div class="d-flex mt-4">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <a href="#" class="fw-semibold">{{ ($user->profile) ? $user->profile->website : '' }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end col-->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-header align-items-center d-flex">
                                                            <h4 class="card-title mb-0  me-2">Recent Posts</h4>
                                                        </div>
                                                        <div class="card-body">
                                                           <div class="row">
                                                               @foreach($user->posts as $post)
                                                                   ...
                                                                   <div class="card border">
                                                                       <div class="card-body">
                                                                           <div class="d-sm-flex">
                                                                               <div class="flex-shrink-0">
                                                                                   <img src="{{ $user->profile_photo }}" alt="" width="115" class="rounded-1">
                                                                               </div>
                                                                               <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                                   ...
                                                                                   <ul class="list-inline mb-0">
                                                                                       <li class="list-inline-item"><i class="ri-user-3-fill text-success align-middle me-1"></i> @ {{ $post->user->username }}</li>
                                                                                       <li class="list-inline-item"><i class="ri-calendar-2-fill text-success align-middle me-1"></i> {{ $post->created_at }}</li>
                                                                                   </ul>
                                                                               </div>
                                                                           </div>
                                                                       </div>
                                ...
                                <!--end tab-pane-->
                                <div class="tab-pane fade" style="display:none" id="projects" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                ...
                                <!--end tab-pane-->
                                <div class="tab-pane fade" style="display:none" id="documents" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-4">
