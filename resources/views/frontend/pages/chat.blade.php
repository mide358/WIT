                ...
                <div class="email-menu-sidebar">
                    <div class="p-4 d-flex flex-column h-100">
                        <div class="pb-4 border-bottom border-bottom-dashed">
                            <a href="{{ route('frontend.learners.dashboard.index') }}" class="btn btn-danger w-100"> <i
                                    class="ri-home-3-fill"></i> Home </a>
                        </div>

                        <div class="mx-n4 px-4 email-menu-sidebar-scroll simplebar-scrollable-y" data-simplebar="init">
                            <div class="simplebar-wrapper" style="margin: 0px -24px;">
                                <div class="simplebar-height-auto-observer-wrapper">
                                    <div class="simplebar-height-auto-observer"></div>
                                </div>
                                @include('frontend.pages.'.strtolower(auth()->user()->role).'s.dashboard.sidebar')

                            </div>
                        </div>
                    </div>
                </div>
                <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1" style="margin-left: 15px!important;">
                                ...
                                <div class="chat-room-list pt-3 simplebar-scrollable-y" data-simplebar="init">
                                                ...
                                                <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                                    ...
                                                    <div class="simplebar-content" style="padding: 16px 0px 0px;">
                                                        <div class="d-flex align-items-center px-4 mb-2">
                                                            <div class="flex-grow-1">
                                                                <h4 class="mb-0 fs-11 text-muted text-uppercase">Direct
                                                                    Messages</h4>
                                                            </div>
                                                            <div class="flex-shrink-0">
                                                        ...
                                                        <div class="chat-message-list">
                                                            ...
                                                            <ul class="list-unstyled chat-list chat-user-list"
                                                                ...
                                                                @foreach($users as $user)
                                                                    ...
                                                                    <?php
                                                                        $route = 'frontend.'.strtolower(auth()->user()->role).'s.dashboard.messages';

                                                                        ?>
                                                                    <li id="contact-id-1" data-name="direct-message"
                                                                        class="{{ ($receiver && ($receiver->slug === $user->sender->slug)) ? 'active' : ''  }}"><a href="{{ route($route, ['slug' => $user->sender->slug]) }}">
                                    ...
                                    <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                                        <div class="simplebar-scrollbar"
                                             style="height: 65px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="user-chat w-100 overflow-hidden">
                                        <div class="chat-content d-lg-flex">
                                            <!-- start chat conversation section -->
                                                <div class="w-100 overflow-hidden position-relative" style="background-color: white; width: 1100px!important; height: 800px">
                                                    <h1 class="mt-4">No messages</h1>
                                                </div>
                                        </div>
                                </div>
                            @else
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="flex-grow-1 overflow-hidden">
                                                                                <h5 class="text-truncate mb-0 fs-16"><a
                                                                                        ...
                                                                                        aria-controls="userProfileCanvasExample">{{ ($receiver) ? $receiver->full_name : '' }}
                                                                                        Parker</a></h5>
                                                    ...
                                                    <div class="chat-conversation p-3 p-lg-4 simplebar-scrollable-y"
                                                        ...
                                                        <div class="simplebar-wrapper" style="margin: -24px;">
                                                                        ...
                                                                        <div class="simplebar-content" style="padding: 24px;">
                                                                            ...
                                                                            <ul class="list-unstyled chat-conversation-list"
                                                                                ...
                                                                                @foreach($chats as $chat)
                                                                                    <li class="chat-list {{ (auth()->user()->id === $chat->sender_id) ? 'right' : 'left' }}" id="1">
                                                                                        <div class="conversation-list">
                                                                                            ...
                                                                                            <div class="user-chat-content">
                                                                                                ...
                                                                                                <div class="conversation-name"><span
                                                                                                        class="d-none name">Lisa Parker</span><small
                                                                                                        class="text-muted time">{{ $chat->created_at->diffForHumans() }}
                                                                                                    </small> <span
                                                            ...
                                                            <div class="simplebar-placeholder"
                                                                 style="width: 1320px; height: 622px;"></div>
                                                        </div>
                                                        ...
                                                        <div class="simplebar-track simplebar-vertical"
                                                            ...
                                                            <div class="simplebar-scrollbar"
                                                                 style="height: 66px; display: block; transform: translate3d(0px, 0px, 0px);"></div>
                                                        </div>
                                                    </div>
                                                    <div
