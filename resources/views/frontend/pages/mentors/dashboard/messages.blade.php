                                                            ...
                                                            <ul class="list-unstyled chat-list chat-user-list"
                                                                ...
                                                                @foreach($users as $user)
                                                                    <li id="contact-id-1" data-name="direct-message"
                                                                        class="active"><a href="{{ route('frontend.learners.dashboard.messages', ['slug' => $user->slug]) }}">
                                                                    ...
                                                                    <li class="chat-list right" id="2">
                                                                        <div class="conversation-list">
                                                                            <div class="user-chat-content">
                                                                                ...
                                                                                <div class="conversation-name"><span
                                                                                        class="d-none name">Frank Thomas</span><small
                                                                            ...
                                                                            <div class="user-chat-content">
                                                                                ...
                                                                                <div class="ctext-wrap">
                                                                                    <div class="ctext-wrap-content"
                                                                                         id="4"><p
                                                                                            class="mb-0 ctext-content">
                                                                                            Hey, I'm going to meet a
                                                                                            friend of mine at the
                                                                                            department store. I have to
                                                                                            buy some presents for my
                                                                                            parents 🎁.</p></div>
                                                                                    <div
                                                                                        class="dropdown align-self-start message-box-drop">
                                                                                        <a class="dropdown-toggle"
