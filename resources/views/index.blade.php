@extends('frontend.layout.master-landing')
...
@section('content')
    ...
    <section class="section job-hero-section bg-light pb-0" id="hero">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    <div>
                        <h1 class="display-6 fw-semibold text-capitalize mb-3 lh-base">Empowering Women in Tech: Mentorship Hub</h1>
                        ...
                        <form action="#" class="job-panel-filter">
                            <div class="row g-md-0 g-2">
                                ...
                                <div class="col-md-4">
                                    <div class="h-100">
                                        <button class="btn btn-primary submit-btn w-100 h-100" type="submit"><i class="ri-search-2-line align-bottom me-1"></i> Find Mentor</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="position-relative home-img text-center mt-5 mt-lg-0">
                        ...
                        <div class="bg-white p-3 rounded shadow-lg application-box">
                            <h5 class="fs-15 lh-base mb-3">Connections</h5>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h1 class="mb-3 ff-secondary fw-semibold lh-base">How <span class="text-primary">it works</span> connects with a mentor quickly</h1>
                        <p class="text-muted">The Women in Tech Mentorship Hub operates by pairing experienced mentors with aspiring mentees in the tech industry.</p>
                    </div>
                </div>
                <!-- end col -->
            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card shadow-none">
                        <div class="card-body p-4">
                            ...
                            <h6 class="fs-17 mb-2">Add Interest</h6>
                            <p class="text-muted mb-0 fs-15">Create interests.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card shadow-none">
                        <div class="card-body p-4">
                            ...
                            <h6 class="fs-17 mb-2">Connect with Mentors</h6>
                            <p class="text-muted mb-0 fs-15">Connect with mentors interested in.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card shadow-none">
                        <div class="card-body p-4">
                            ...
                            <h6 class="fs-17 mb-2">Ask Questions</h6>
                            <p class="text-muted mb-0 fs-15">Ask questions in the forum section.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section bg-light" id="categories">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="text-center mb-5">
                        <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">Let the <span class="text-primary">Numbers</span> do the talking </h1>
                    </div>
                </div>
                <!-- end col -->
            </div>
    ...
    <section style="display:none" class="section" id="findJob">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="text-center mb-5">
    ...
    <section class="section bg-light" id="candidates">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">Connect with Mentors <span class="text-primary">Now</span></h1>
                        <p class="text-muted mb-4">Once paired, mentors and mentees communicate through our platform via messaging, video calls, or in-person meetings, fostering a supportive and collaborative relationship.</p>
                    </div>
                </div>
                <!-- end col -->
            </div>
    ...
    <section class="section" id="blog">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">Our Latest <span class="text-primary">Articles</span></h1>
                        <p class="text-muted mb-4">Discover the Latest Insights in Tech Innovation and Leadership in Our Newest Article!</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
